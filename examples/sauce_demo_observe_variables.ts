// Run with: npm exec -- tsx examples/sauce_demo_observe_variables.ts
// Run with delay: npm exec -- tsx examples/sauce_demo_observe_variables.ts --add-delay
//
// This example opens the Sauce Demo landing page and uses a Stagehand
// variable in `observe` to find matching form fields.
...
/**
 * Opens the Sauce Demo landing page and asks Stagehand to observe fields using
 * a variable in the instruction.
 */
async function main(): Promise<void> {
  ...
  const userDataDir = createAutomationUserDataDir(
    "stagehand-sauce-demo-observe-variables-",
  );
  ...
  const stagehand = new Stagehand({
    ...
    // cacheDir: "runtime/cache/sauce_demo_observe_variables",
  });
  ...
  try {
    ...
    console.log("Observed variable-matched actions:");
